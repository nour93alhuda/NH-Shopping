...
const product1=new products('iphone 15','1300 $','mobile','images/iphone15.jpg',1);
const product2=new products('headphone','1400 $','accessories ','images/head1.jpg',2);
const product3=new products('iphone x','700 $','mobile','images/iphonex.jpg',3);
const product4=new products('lenovo','500 $','laptop','images/l2.jpg',4);
const product5=new products('toshipa','600 $','laptop','images/toshiba.jpg',5);
const product6=new products('Iphone 14','1200 $','Mobile','images/iphone14.jpg',6);
const product7=new products('earphone',' 110 $','accessories','images/earphone.jpg',7);
const product8=new products('apple','800 $','laptopt','images/lapple2.jpg',8);
const product9=new products('iphone 13','950 $','mobile','images/iphone13.jpg',9);
