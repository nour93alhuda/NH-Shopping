...
console.log("p",price,price[0])
        // s+= parseInt(price[0]);
        // console.log("t",parseInt(price[0]))
       
       arr.push(parseInt(price[0]))
    //    console.log(arr)
    ...
    for(let i in items){
        console.log(arr[i])* parseInt(items[i].count)
       
        sum += (arr[i])* parseInt(items[i].count) 
